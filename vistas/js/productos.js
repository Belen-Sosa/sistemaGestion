...
function listarDetalles() {
  ...
  for (var i = 0; i < detalles.length; i++) {
    if (detalles[i].estado == 1) {
      if (
        detalles[i].id_categoria == "9" ||
        detalles[i].id_categoria == "11" ||
        detalles[i].id_categoria == "14"
      ) {
        var importe = (detalles[i].importe =
          (detalles[i].precio / 1000) * detalles[i].cantidad);
        ...
        var filas =
          ...
          "</td> <td name='producto[]'>" +
          detalles[i].producto +
          "</td> <td><input name='precio[]' id='precio[]'' value='" +
          detalles[i].precio +
          "' onClick='setPrecioCompra(event, this, " +
          i +
          ");'  onKeyUp='setPrecioCompra(event, this, " +
          i +
          ");'></td> <td> " +
          $stock_grs +
          ...
          ");' value='" +
          detalles[i].cantidad +
          "'>grs.  </td> <td><input type='number' name='descuento[]' required id='descuento[]' onClick='setDescuento(event, this, " +
          i +
          ...
          "'>$ " +
          detalles[i].importe +
          "</span> </td> <td>  <button href='#' class='btn btn-danger btn-lg' role='button' onClick='eliminarProdCompras(event, " +
          i +
        ...
        var filas =
          ...
          ");' value='" +
          detalles[i].cantidad +
          "'></td>  <td><input type='number' name='descuento[]'required id='descuento[]' onClick='setDescuento(event, this, " +
          i +
          ");' onKeyUp='setDescuento(event, this, " +
          i +
          ");' value='" +
...
function setDescuento(event, obj, idx) {
  ...
  if (
    ...
    parseInt(obj.value) == null ||
    parseInt(obj.value) == NaN
  ) {
...
function recalcular(idx) {
  if (
    detalles[idx].id_categoria == "9" ||
    detalles[idx].id_categoria == "11" ||
    detalles[idx].id_categoria == "14"
  ) {
    var importe =
      (detalles[idx].importe = detalles[idx].precio / 1000) *
      detalles[idx].cantidad;
    importe = detalles[idx].importe =
      detalles[idx].importe -
      (detalles[idx].importe * detalles[idx].dscto) / 100;
  } else {
  ...
  for (var i = 0; i < detalles.length; i++) {
    if (detalles[i].estado == 1) {
      if (
        ...
        subtotal =
          (subtotal + detalles[i].precio / 1000) * detalles[i].cantidad -
    ...
    if (detalles[i].estado == 1) {
      if (
        ...
        var filas =
          ...
          ");' value='" +
          detalles[i].cantidad +
          "'>  grs.</td>  <td><input type='text' name='descuento[]' id='descuento[]' required -onClick='setDescuento(event, this, " +
          i +
          ");' onKeyUp='setDescuento(event, this, " +
          i +
          ");' value='" +
        ...
        var filas =
          ...
          ");' value='" +
          detalles[i].cantidad +
          "'> </td>  <td><input type='text' name='descuento[]' id='descuento[]' required onClick='setDescuento(event, this, " +
          i +
          ");' onKeyUp='setDescuento(event, this, " +
          i +
          ");' value='" +
...
function recalcular(idx) {
  ...
  if (
    ...
    var importe = (detalles[idx].importe =
      (detalles[idx].precio / 1000) * detalles[idx].cantidad);
    importe = detalles[idx].importe =
      detalles[idx].importe -
      (detalles[idx].importe * detalles[idx].dscto) / 100;
  } else {
  ...
  for (var i = 0; i < detalles.length; i++) {
    if (detalles[i].estado == 1) {
      if (
        ...
        subtotal =
          subtotal + precioxkilo - (precioxkilo * detalles[i].dscto) / 100;
      } else {
        subtotal =
          subtotal +
          detalles[i].cantidad * detalles[i].precio -
          ...
          if (
            ...
            $.ajax({
              ...
              success: function (data) {
                ...
                //muestra un mensaje de exito
                setTimeout(
                  "bootbox.alert('Se ha registrado a cuenta corriente');",
                  100
                );
                //refresca la pagina, se llama a la funtion explode
                setTimeout("explode();", 2000);
